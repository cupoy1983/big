...
class TaobaoCollectAction extends CommonAction
{
	...
	public function shop()
	{
		...
		{
			echoFlush('<script type="text/javascript">setTimeout(function(){location.href="'.U('TaobaoCollect/shop',array('time'=>TIME_UTC)).'";},1000);</script>');
		}
		else
		{
	...
	public function goods()
	{
		...
		{
			echoFlush('<script type="text/javascript">setTimeout(function(){location.href="'.U('TaobaoCollect/goods',array('time'=>TIME_UTC)).'";},1000);</script>');
		}
		else
		{
	...
	public function share()
	{
		...
		if(FS("Goods")->share() == 0)
		{
			echoFlush('<script type="text/javascript">setTimeout(function(){location.href="'.U('TaobaoCollect/share',array('time'=>TIME_UTC)).'";},1000);</script>');
		}
		else
		{
	...
	public function collect()
	{
		...
		else
		{
			...
			{
				echoFlush('<script type="text/javascript">setTimeout(function(){location.href="'.U('TaobaoCollect/collect',array('time'=>TIME_UTC)).'";},500);</script>');
				exit;
			}
			else
				$_SESSION['taobao_collect_errnum'] = 0;
		...
		echoFlush('<script type="text/javascript">setTimeout(function(){location.href="'.U('TaobaoCollect/collect',array('time'=>TIME_UTC)).'";},1000);</script>');
    }
