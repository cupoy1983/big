...
class TagLibFanwe extends TagLib
{
	protected $tags =  array(
		...
		'linkBtn'=>array('attr'=>'name,text,id,style,href,target,css','level'=>1,'close'=>0),
    ...
    public function _linkBtn($attr)
    {
        ...
        $parseStr   = '<div class="link-button '.$style.'" style="'.$css.'"><p><a id="'.$id.'" name="'.$name.'" href="'.$href.'" class="'.$name.'"'.$target.'>'.$text.'</a></p></div>';
        return $parseStr;
    }
