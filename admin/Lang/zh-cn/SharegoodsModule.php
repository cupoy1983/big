...
$array = array(
	...
	'TAOBAO_IS_TDJ'=>'使用淘点金',
	'TAOBAO_IS_TDJ_TIPS'=>'(如果没有淘宝客API权限，请选择使用淘点金，以转换佣金链接)',
	'TAOBAO_RD'=>'商品显示方式',
	'TAOBAO_RD_1'=>'商品详细',
	'TAOBAO_RD_2'=>'淘宝热卖',
	...
	'JDBUY_UNIONID_TIPS'=>'申请地址：http://cps.jd.com/',

	'VANCL_SOURCE'=>'Source',
	'VANCL_SOURCE_TIPS'=>'申请地址：http://union.vancl.com/',

	'DANGDANG_FROM'=>'from',
	'DANGDANG_FROM_TIPS'=>'申请地址：http://union.dangdang.com/',
	
	'AMAZON_TAG'=>'跟踪代码',
	'AMAZON_TAG_TIPS'=>'申请地址：https://associates.amazon.cn/',
	
	'YIQIFA_SITE_ID'=>'网站ID',
	'YIQIFA_UID'=>'网站主ID',
	'YIQIFA_DATA_SECRET'=>'数据私钥',
	'YIQIFA_UID_TIPS'=>'网站ID ,一定要使用购物客站点对应的站点id',
