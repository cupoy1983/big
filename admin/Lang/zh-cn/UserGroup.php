...
return array(
	...
	'ACCESS'=>'前台权限设置',
	'CREDITS_RANGE'=>'积分范围',
	'GOODS_COMMISSION_SCORE_TYPE'=>'佣金返积分比率',
	'GOODS_BUY_SCORE_TYPE'=>'购买返积分比率',
	'IS_ADMIN'=>'网站工作人员组',
	'ICON'=>'会员组小图标',
	...
	'COMMISSION_RATE_TIP'=>'当会员发布的淘宝推广商品，产生佣金时，返现给发布会员的积分百分比',
	'BUY_RATE_TIP'=>'当会员点击淘宝推广商品，成功购买，并产生佣金时，返现给购买会员的积分百分比；<br/>当发布商品的会员和购买商品的会员为同一个会员时，只会产生<span style="color:#f00;">购买返积分</span>，而不会产生<span style="color:#f00;">佣金返积分</span>。',
	...
	'GOODS_BUY_SCORE_TYPE_0'=>'不返积分',
	'GOODS_BUY_SCORE_TYPE_1'=>'根据成交金额',
        'GOODS_BUY_SCORE_TYPE_2'=>'根据佣金金额',
    
        'GOODS_COMMISSION_SCORE_RATE'=>'佣金返积分',
        'GOODS_BUY_SCORE_RATE'=>'购买返积分',
);
return $array;
?>